...
export const WhiteNoise: Component = () => {
  ...
  const noises = [
    ...
    { id: 'ocean', name: 'Ocean Waves', icon: '🌊', description: 'Calming sea sounds' },
    { id: 'forest', name: 'Forest', icon: '🌲', description: 'Birds and rustling leaves' },
    ...
    { id: 'white', name: 'White Noise', icon: '📻', description: 'Pure static sound' },
  ]
    ...
    <div class="flex min-h-full flex-col p-6">
      ...
      {selectedNoise() && (
        <div class="mt-auto space-y-4">
          ...
          {/* Volume control */}
          <div class="w-full">
            <label class="mb-2 block text-center text-lg font-semibold">Volume</label>
            <input
              type="range"
              min="0"
              max="100"
